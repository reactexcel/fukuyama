...
$page_title = "President's Message | Fukuyama Transporting";
$page_description = "Learn more about Fukuyama Transporting's president, Shigehiro Komaru. Fukuyama Transporting is one of the leading logistics companies in Japan today, with 26,000 employees in approximately 400 branches across the country.";
   ...
   <div class="col-xs-12" style="position:relative;">
      <img src="images_ie/headertrucks.jpeg" width="100%" style="z-index:1; width:100%; height:350px;"/>
         <div style="z-index:999;position:absolute;top:30px; left:4%; margin:0px auto; width:70%">
            <p class="headertext">President's Message<br></p>
...
<div class="container" >
   <div class="row no-gutters">
      <div class=" col-xs-10 col-xs-offset-1  col-md-8 col-md-offset-2 mt-50">
         ...
         <h3>Message From President Shigehiro Komaru</h3>
         <hr />
         <p>
            ...
            <br><br>
            Thank you for your continued support and encouragement.</p><br><br>
         <div class="col-xs-8 col-sm-3">
            <img src="images/president.jpg" class="img-responsive"> 
         </div>
         <div class="col-xs-8 col-sm-7">
            <p class="subtitle">Shigehiro Komaru</p>
            <p>President</p>
         </div>
      </div>
   </div>
